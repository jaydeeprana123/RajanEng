                  ...
                  Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 15.mh),
                        Text("Oops, No Internet Conenction!",
                            textAlign: TextAlign.center,
                            style: TextStyle(
                                fontSize: responsiveFontSize(context, 16).msp,
                                fontFamily: fontMulishBold,
                                color: widget.txtColor)),
                        SizedBox(height: 9.mh),
                        Text(
                            "Make sure wifi or cellular data is turned on\nand then try again.",
                            textAlign: TextAlign.center,
                            style: TextStyle(
                                fontSize: responsiveFontSize(context, 12).msp,
                                fontFamily: fontMulishRegular,
                                color: widget.descColor)),
                        SizedBox(height: 29.mh),
                        ElevatedButton(
                            onPressed: () {
                              widget.onTap;
                            },
